...
struct BuildParameterList<Legion::FieldAccessor<PM, FT, n_dims, coord_t, Realm::AffineAccessor<FT, n_dims, coord_t>, false>>
{
  using type = ParameterList<std::integral_constant<legion_privilege_mode_t, PM>, FT, std::integral_constant<int_t, n_dims>>;
};
...
struct ApplyFieldAccessor
{
  ...
  using apply = Legion::FieldAccessor<PM::value, FT, n_dims::value, coord_t, Realm::AffineAccessor<FT, n_dims::value, coord_t>, false>;
};
