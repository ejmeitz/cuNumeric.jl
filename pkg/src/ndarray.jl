...
function Base.getindex(arr::NDArray, i::Int64)
    acc = get_read_accessor_double_1d(arr); 
    return read_double_1d(acc, i - 1)
end

function Base.setindex!(arr::NDArray, value::Union{Float32, Float64}, i::Int64)
    acc = get_write_accessor_double_1d(arr);
    write_double_1d(acc, i - 1, value)
end
